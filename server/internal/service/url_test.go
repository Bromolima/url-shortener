...
// 	hashUrlServiceMock := mocks.NewMockHashUrlService(control)
// 	service := NewUrlService(repositoryMock, hashUrlServiceMock)
...
// 				hashUrlServiceMock.EXPECT().EncodeUrl("https://example.com").Return("somehash")
